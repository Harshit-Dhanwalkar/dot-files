...
local function setup(_, options)
	...
	-- override the default size to return nothing
	...
	--
	-- 	if percent == 0 then
	-- 		percent = string.format(" Top ")
	-- 	elseif percent == 100 then
	-- 		percent = string.format(" Bot ")
	-- 	else
	...
	Status:children_remove(3000, Status.LEFT) -- Remove default left size
	Status:children_remove(5000, Status.RIGHT) -- Removes default percentage
	Status:children_remove(6000, Status.RIGHT) -- Removes default position (1/10)

	Status:children_add(Status.files, 4000, Status.LEFT)
	Status:children_add(Status.size, 1000, Status.RIGHT)
	Status:children_add(Status.right_size, 500, Status.RIGHT)
end
