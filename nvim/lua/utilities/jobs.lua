-- ~/.config/nvim/lua/utilities/jobs.lua

-- Credits:
-- https://github.com/wurli/dotfiles/blob/main/.config/nvim/lua/utils/jobs.lua
...
function jobpane:send(lines)
	...
	if self:is_open() then
		local line = vim.api.nvim_win_call(self._win, function()
			return vim.fn.line("$")
		end)
