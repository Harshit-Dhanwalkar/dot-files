...
require("lazy").setup({
	...
	require("Plugins.others.lightswtich"),
	-- require("Plugins.Ohters.screenkey"),
	-- require("Plugins.Ohters.showkeys"),
	...
	-- require("Plugins.others.twilight"),
