...
require("lazy").setup({
	...
	-- FIX:
	-- require("plugins.utils.visimatch"),
	require("plugins.utils.vim-matchup"),
	-- require("plugins.utils.harpoon"),
	require("plugins.utils.nvim-numbertoggle"),
	require("plugins.latex.vimtex"),
	-- require("plugins.latex.render_latex"),
	...
	require("plugins.others.urlpreview"),
	...
	require("plugins.webdev.nvim-ts-autotag"),
